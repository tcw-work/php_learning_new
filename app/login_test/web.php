            ...
            <div id="instanceFlag">
                ...
                <section id="web01" class="web_section">
                    <form action="function/save.php" method="GET" class="myForm">
                        ...
                        <input type="text" name="auther01" class="auther01" placeholder="執筆者/組織名"
                        ...
                        <input type="text" name="url" class="url required" placeholder="URL（必須）"
                            oninput="updateComplete1()" v-model="bookName" @input="checking">
                        <input type="text" name="access" class="access" placeholder="最後にアクセスした日付"
                            oninput="updateComplete1()">
                        <div class="cmp_box">
                            <div class="cmp_in">
                            ...
                            <input type="hidden" name="complete" class="complete" placeholder="例：作者名 (発行日) ｢本の名前｣ 出版社"
                                readonly>
                            <div class="cmp_func">
                                <p><span><img :src=" bookImage" alt=""></span><input type="submit" value="保存"
                                        class="submit" v-bind:class="{ 'ctrAct': ctrFlag }" @click="ctrInp" disabled>
                                </p>
                ...
                <section id="web02" class="web_section">
                    <form action="function/save.php" method="GET" class="myForm">
                        ...
                        <input type="text" name="heading" class="heading" placeholder="ページ名 or 資料名"
                            oninput="updateComplete2()">
                        <input type="text" name="name" class="name" placeholder="Webサイトの名前" oninput="updateComplete2()">
                        <input type="text" name="url" class="url required" placeholder="URL（必須）"
                            oninput="updateComplete2()" v-model="bookName" @input="checking">
                        <input type="text" name="access" class="access" placeholder="最後にアクセスした日付"
                            oninput="updateComplete2()">
                        <div class="cmp_box">
                            <div class="cmp_in">
                ...
                <section id="web03" class="web_section">
                    <form action="function/save.php" method="GET" class="myForm">
                        ...
                        <input type="text" name="auther02" class="auther02" placeholder="執筆者/組織名02"
                            oninput="updateComplete3()">
                        <input type="text" name="auther03" class="auther03" placeholder="執筆者/組織名03"
                            oninput="updateComplete3()">
                        ...
                        <input type="text" name="url" class="url required" placeholder="URL（必須）"
                            oninput="updateComplete3()" v-model="bookName" @input="checking">
                        <input type="text" name="access" class="access" placeholder="最後にアクセスした日付"
                            oninput="updateComplete3()">
                        <div class="cmp_box">
                            <div class="cmp_in">
                ...
                <section id="web04" class="web_section">
                    <form action="function/save.php" method="GET" class="myForm">
                        ...
                        <input type="text" name="medium" class="medium" placeholder="論文が掲載された書籍名"
                            oninput="updateComplete4()">
                        ...
                        <input type="text" name="page02" class="page02" placeholder="終わりのページ番号"
                            oninput="updateComplete4()">
                        <!-- <input type="text" name="heading" class="heading" placeholder="ページ名 or 資料名" oninput="updateComplete4()"> -->
                        <input type="text" name="url" class="url required" placeholder="URL(必須)"
                            oninput="updateComplete4()" v-model="bookName" @input="checking">
                        <input type="text" name="access" class="access" placeholder="最後にアクセスした日付"
                            oninput="updateComplete4()">
                        <div class="cmp_box">
                            <div class="cmp_in">
