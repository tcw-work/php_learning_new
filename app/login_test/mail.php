<?php
function send_mail($user_name, $user_mail) {// $user_name, $user_pass, $user_mail を使用してメールの処理を行う（引数の内容はdb.phpで呼び出されたときに定義されている）
...
//件名や本文をチェック
$subject = "登録メールのテスト";
$body = "こんにちは{$user_name}さん。メールの本文（テスト）です。";//。$user_nameはdb.phpで定義
//日本語メール送信
